...
Module Module1
    ...
    Sub Main()
        ...
        Dim dir As String
        strInputDirectory = objIniFile.GetString("ITWPharm", "ITWPharminputDir", "(none)") 'D:\feeds\HL7\ITWPharm\
        strOutputDirectory = objIniFile.GetString("ITWPharm", "ITWPharmoutputdirectory", "(none)") 'D:\feeds\ltw\ITWPharm\
        strMapperFile = objIniFile.GetString("ITWPharm", "ITWPharmmapper", "(none)")
